...
function form_action() {
	var current_action = document.getElementById('osp_submission').action;
	var email = document.getElementById('email').value;
	var new_action = current_action+'?email='+encodeURIComponent(email);
	document.getElementById('osp_submission').action = new_action;
}
</script>
<h3>STEP 1: To redeem online, begin by completing the form below.</h3>
<form action="<?php bloginfo('home');?>/osp/" method="post" enctype="multipart/form-data" name="osp_submission" id="osp_submission" class="form_body">
