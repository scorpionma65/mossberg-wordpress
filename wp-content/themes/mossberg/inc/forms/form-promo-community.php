<form action="<?php bloginfo('home');?>/join-the-mossberg-community/" method="post" enctype="multipart/form-data" name="community_promo" id="community_promo" class="form_body">
