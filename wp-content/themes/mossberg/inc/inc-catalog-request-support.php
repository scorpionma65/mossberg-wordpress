...
if(isset($_POST['submit'])) {
	...
	if($firstname && $lastname && $address && $city && $state && $zip) {	
		...
		// Form Response
		$args = array('category_name'=>'catalog-request-support-response', 'numberposts'=>1);
...
// Form
if($show) {
	include(TEMPLATEPATH.'/inc/forms/form-catalog-request-support.php');
}
?>
