...
<?php include(TEMPLATEPATH.'/inc/inc-slider-tab.php');?>
</div>
<!-- Slider -->
...
<source src="<?php bloginfo('home');?>/wp-content/uploads/video/mossberg-shot-show.mp4" type="video/mp4">
<source src="<?php bloginfo('home');?>/wp-content/uploads/video/mossberg-shot-show.webm" type="video/webm">
<source src="<?php bloginfo('home');?>/wp-content/uploads/video/mossberg-shot-show.ogv" type="video/ogg">
</video>
