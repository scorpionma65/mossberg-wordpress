<?php
/*
Template Name: International Distributors
*/
?>
<?php get_header(); ?>
...
<?php 
//$cat_slug = 'intl-distributors';
//$map_zoom = '2';
//$map_center = "25.00, 15.00";
...
<?php
$args = array('category_name'=>$cat_slug,'showposts'=>-1,'orderby'=>array('meta_value'=>'ASC','title'=>'ASC'),'meta_key'=>'Location Country','order'=>'ASC');
query_posts($args);
while(have_posts()):the_post();
	...
	$location_state = get_post_meta($post->ID, 'Location Country', true);
